...
Мобільний клієнт, побудований на базі **React Native** та **Expo**. Він має 3 основні сторінки: аналіз страви, історія сканувань та налаштування персонального профілю (вік, стать, алергії).
